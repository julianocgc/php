...
$res = mysql_query("SELECT nome FROM chat WHERE origem='A' and msg=''");
if(mysql_num_rows($res)==0) {	
	...
	$res = mysql_query("SELECT * FROM chat WHERE origem='C' and nome<>'$idConversa'");
	if(mysql_num_rows($res)>0) {
		echo "<html>";
		echo "<body>";
...
<?php	
	...
	$res = mysql_query("INSERT INTO chat VALUES('$idConversa','C','')");
	$res = mysql_query("INSERT INTO chat VALUES('$nome','C','[Entrou no chat]')");
?>
