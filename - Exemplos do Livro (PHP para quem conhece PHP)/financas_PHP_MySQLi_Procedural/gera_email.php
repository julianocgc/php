...
else
{
    ...
    else
    {
        ...
        $res = mysqli_query($con, "select descricao,valor from receitas_despesas where usuario='$usuario' and data='$data_buscar' and (tipo='DF' or tipo='DV') order by descricao");
